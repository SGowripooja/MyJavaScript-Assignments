...
xhr.onload = function(){
    ...
    // Using for in 
    for (var x in data){
        console.log('This is printed using for in '+ data[x].continents);
    }
    // Using for of:
    for (var y of data){
       console.log('This is printed using for of '+y.name.common); 
    }
    // Using for each:
    data.forEach(element => {
        console.log('This is printed using foreach '+ element.flag);
    });
}
